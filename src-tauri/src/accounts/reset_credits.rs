...
pub(super) fn consume_profile_reset_credit_internal(
    state: &AppState,
    profile_id: &str,
    credit_id: &str,
    idempotency_key: &str,
...
pub(super) fn validate_reset_credit_request(
    credit_id: &str,
    idempotency_key: &str,
...
#[derive(Serialize)]
pub(super) struct ResetCreditConsumeRequest<'a> {
    pub(super) redeem_request_id: &'a str,
    pub(super) credit_id: &'a str,
}
...
pub(super) fn parse_reset_credit_consume_response(
    body: &str,
...
#[derive(Deserialize)]
pub(super) struct ResetCreditResponse {
    id: String,
    title: String,
    status: String,
    expires_at: String,
...
pub(super) fn build_reset_credit_request(
    client: &Client,
