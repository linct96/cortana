use super::local_web;
use super::state::{AppState, TRAY_ID};
use tauri::{
    menu::{Menu, MenuItem},
...
pub(crate) fn install_tray(app: &tauri::AppHandle) -> Result<(), String> {
...
pub(crate) fn refresh_tray(app: &tauri::AppHandle) -> Result<(), String> {
    let menu = build_tray_menu(app)?;
...
pub(crate) fn build_tray_menu(app: &tauri::AppHandle) -> Result<Menu<tauri::Wry>, String> {
