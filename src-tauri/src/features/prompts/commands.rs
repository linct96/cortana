use super::{
    store::{get_agents_profile, get_profile_content, list_agents_profiles},
    types::{AgentsProfile, AgentsStatus},
};
use crate::{
    ...
    platform::{
        ...
        state::{now_millis, AccountProduct, AppState},
    },
    products::codex::{auth_path, read_optional_file, restore_optional_file},
};
...
pub(crate) fn get_agents_status(
...
pub(crate) fn create_agents_profile(
    state: State<'_, AppState>,
    product: AccountProduct,
    name: String,
    content: String,
...
pub(crate) fn update_agents_profile(
    state: State<'_, AppState>,
    product: AccountProduct,
    profile_id: String,
    name: String,
...
pub(crate) fn activate_agents_profile(
    state: State<'_, AppState>,
    product: AccountProduct,
    profile_id: String,
    force: bool,
...
pub(crate) fn import_current_agents(
    state: State<'_, AppState>,
    product: AccountProduct,
    name: String,
) -> Result<AgentsProfile, String> {
...
pub(crate) fn delete_agents_profile(
    state: State<'_, AppState>,
    product: AccountProduct,
    profile_id: String,
) -> Result<(), String> {
...
mod tests {
    use super::{
        activate_agents_profile_internal, create_agents_profile_internal,
        delete_agents_profile_internal, get_agents_status_internal, import_current_agents_internal,
        instruction_path, update_agents_profile_internal, write_file_atomically, AccountProduct,
        AgentsProfile, AppState, PathBuf, Uuid,
    };
    use crate::platform::db::{get_setting, initialize_database, open_database};
    use std::{
        fs,
        sync::{Arc, Mutex},
    };
